...
#ifndef _THREEROOMS_H_
#define _THREEROOMS_H_
...
class ThreeRooms: public Environment {
public:
  ...
  */
  ThreeRooms(Random &rand, bool stochastic, bool rewardType, int actDelay, bool multiGoal);
