...
void initEnvironment(){
  ...
  // grid world 
  else if(strcmp(envType, "gridworld") == 0){
    desc.title = "Environment: Gridworld 2\n";
    e = new Gridworld2(5, 1, 4, 0);
  }

 // three rooms
  else if (strcmp(envType, "threerooms") == 0){
    desc.title = "Environment: ThreeRooms\n";
    e = new ThreeRooms(rng, stochastic, true, delay, false);
  }

  else if(strcmp(envType, "autodock") == 0){
    desc.title = "Environment: AutoDock\n"; 
    e = new AutoDockBot(100); 
  }
